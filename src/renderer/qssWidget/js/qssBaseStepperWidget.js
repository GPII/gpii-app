...
(function (fluid) {
    ...
    fluid.defaults("gpii.qssWidget.baseStepper", {
        ...
        invokers: {
            activateIncBtn: {
                funcName: "gpii.qssWidget.baseStepper.activateIncButton",
                args: [
                    "{that}",
                    "{that}.dom.incButton",
            ...
            activateDecBtn: {
                funcName: "gpii.qssWidget.baseStepper.activateDecButton",
                args: [
                    "{that}",
                    "{that}.dom.decButton",
        ...
        components: {
            ...
            indicators: {
                ...
                options: {
                    model: {
                        setting: "{baseStepper}.model.setting"
                    }
                }
            }
        }
     ...
     */
    gpii.qssWidget.baseStepper.activateIncButton = function (that, button) {
     ...
     * in the QSS stepper widget.
     */
    gpii.qssWidget.baseStepper.activateDecButton = function (that, button) {
     ...
     */
    gpii.qssWidget.baseStepper.makeRestrictedStep = function (that, value, schema, shouldSubtract) {
