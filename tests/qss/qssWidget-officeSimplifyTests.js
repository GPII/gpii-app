...
function getOfficeSimplifyWidgetBtnText() {
    return jQuery(".fl-qss-btnId-office-simplification > span").text();
}

fluid.registerNamespace("gpii.tests.qss.officeSimplifyTests");
...
gpii.tests.qss.officeSimplifyTests = [
    { // Open the QSS...
        ...
        args: [
            ...
            getOfficeSimplifyWidgetBtnText
        ],
