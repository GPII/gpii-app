...
function getCustomizeQuickstripBtnText() {
    return jQuery(".fl-qss-btnId-url-customize-qss > span").text();
}

fluid.registerNamespace("gpii.tests.qss.customizeQuickstripTests");
...
gpii.tests.qss.customizeQuickstripTests = [
    { // Open the QSS...
        ...
        args: [
            ...
            getCustomizeQuickstripBtnText
        ],
        resolve: "jqUnit.assertEquals",
        resolveArgs: [
            "Text of the button should be",
            "Customize Quickstrip",
            "{arguments}.0"
        ]
    }, { // Close the QSS
