...
function getScreenCaptureWidgetBtnText() {
    return jQuery(".fl-qss-btnId-screen-capture > span").text();
}

fluid.registerNamespace("gpii.tests.qss.screenCaptureTests");
