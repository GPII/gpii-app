...
var qssCrossTestSequence = [
    ...
    { // ... should notify the core
        ...
        args: [
            "Change event was fired from QSS widget interaction.",
            { path: "http://registry\\.gpii\\.net/applications/com\\.microsoft\\.windows\\.mouseSettings.SwapMouseButtons", value: true },
            "{arguments}.0"
        ]
    },
    ...
    { // ... should notify the core
        ...
        args: [
            "Change event was fired from QSS widget interaction.",
            { path: "http://registry\\.gpii\\.net/applications/com\\.microsoft\\.windows\\.mouseSettings.easierDoubleClick", value: true },
            "{arguments}.0"
        ]
    },
